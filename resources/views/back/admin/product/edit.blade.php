...
<div class="page-content fade-in-up">
    <div class="alert bg-white d-flex justify-content-between align-items-center">
        ...
        <a href="{{route('admin.Part.list',['id'=>$subcategories->id])}}" class="btn btn-primary">Back</a>
    </div>
    <div class="ibox">
        <div class="ibox-head">
            <div class="ibox-title">Update Product</div>
        ...
        <div class="ibox-body">
            <form class="form-horizontal" id="form-sample-1" method="post"
                action="{{ route('admin.Part.update', $data->id) }}" novalidate="novalidate"
                ...
                <div class="form-group row">
                    ...
                    <input class="form-control" type="text" name="service_id" value="{{$service->id ?? ''}}" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <input class="form-control" type="text" name="subcategory_id" value="{{$subcategories->id ?? ''}}" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" name="price" value="{{ old('price', $data->price) }}"
                            required>
                    </div>
                </div>
                ...
                <div class="form-group row" id="imagePreviewContainer"
                    style="display: {{ $data->image ? 'block' : 'none' }};">
                    <label class="col-sm-2 col-form-label">Image Preview</label>
                    <div class="col-sm-10">
                        <img id="imagePreview" src="{{ asset('storage/app/public/' . $data->image) }}"
                            alt="Image Preview" style="max-width: 100%; max-height: 100px;" />
                    </div>
                </div>
