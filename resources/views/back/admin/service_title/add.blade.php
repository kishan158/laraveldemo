    ...
    <div class="ibox">
        ...
        <div class="ibox-body">
            <form class="form-horizontal" id="form-sample-1" method="post"
                action="{{route('admin.service.title.submit',$service->id)}}" novalidate="novalidate" enctype="multipart/form-data">
                @csrf
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Service </label>
                    <div class="col-sm-10">
                      <input class="form-control" type="text"  value="{{$service->service}}" required readonly>
                        <input class="form-control" type="hidden" name="service_id" value="{{$service->id}}" required readonly> 
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" name="service_title" required>
                    </div>
                </div>
