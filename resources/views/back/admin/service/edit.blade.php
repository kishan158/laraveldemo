...
<a href="{{route('admin.service.list')}}" class="btn btn-primary">Back</a>
    ...
    <div class="ibox">
        <div class="ibox-head">
            <div class="ibox-title">Update Service</div>
            <div class="ibox-tools">
                <a class="ibox-collapse"><i class="fa fa-minus"></i></a>
            </div>
        </div>
        <div class="ibox-body">
            <form class="form-horizontal" id="form-sample-1" method="post" action="{{ route('admin.service.update',$data->id) }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" name="service" value="{{ $data->service }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <img src="{{ asset('public/front/image/' . $data->image) }}" alt="Current Image"
