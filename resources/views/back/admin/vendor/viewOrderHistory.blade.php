                ...
                <div class="ibox">
                    <div class="ibox-body">
                        <ul class="nav nav-tabs tabs-line">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#tab-5" data-toggle="tab">
                                    <i class="ti-bar-chart"></i> Revisite Order Estimate
                                </a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="#tab-3" data-toggle="tab">
                                    <i class="ti-bar-chart"></i>Partner Details
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#tab-4" data-toggle="tab">
                                    <i class="ti-bar-chart"></i>Customer Details
                                </a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="tab-5">
                                <h5 class="text-info m-b-20 m-t-20"><i class="fa fa-bullhorn"></i>Revisite Order Estimate</h5>
                                <ul class="media-list media-list-divider m-0">
                                    <!-- Order ID -->
                                    <li class="media">
                                        <div class="media-img"><i class="ti-user font-18 text-muted"></i></div>
                                        ...
                                        @else
                                        <div class="media-body">
                                            <div class="media-heading text-success">No Data available.</div>
                            ...
                            <div class="tab-pane fade" id="tab-3">
                                <h5 class="text-info m-b-20 m-t-20">
                                    <i class="fa fa-bullhorn">Partner Photo</i>
                                    @if(!empty($order->vendor->image))
                                    <div class="media-body">
                                        <img class="img-circle small-img"
                                            src="{{ asset('storage/app/public/' . $order->vendor->image) }}"
                                            alt="Image">
                                    </div>
                                    @endif
                                </h5>
                                <ul class="media-list media-list-divider m-0">
                                    ...
                                    <li class="media">
                                        <div class="media-img"><i class="ti-user font-18 text-muted"></i></div>
                                        <div class="media-body">
                                            <div class="media-heading text-success">Partner Name </div>
                                            <div class="font-13">{{ $order->vendor->name ?? '' }}
                                                {{ $order->vendor->last_name ?? '' }}</div>
                                        </div>
                                        <div class="media-body">
                                            <div class="media-heading text-success">Partner Phone </div>
                                            <div class="font-13">{{ $order->vendor->phone ?? '' }}</div>
                                        </div>

                                        <div class="media-body">
                                            <div class="media-heading text-success">Partner Email </div>
                                            <div class="font-13">{{ $order->vendor->email ?? '' }}</div>
                                        </div>
                            ...
                            <div class="tab-pane fade" id="tab-4">
                                ...
                                <ul class="media-list media-list-divider m-0">
                                    ...
                                    <li class="media">
                                        <div class="media-img"><i class="ti-user font-18 text-muted"></i></div>
                                        <div class="media-body">
                                            <div class="media-heading text-success">Customer Name </div>
                                            <div class="font-13">{{ $order->customer->name ?? '' }}
                                                {{ $order->customer->last_name ?? '' }}</div>
                                        </div>
                                        <div class="media-body">
                                            <div class="media-heading text-success">Customer Phone </div>
                                            <div class="font-13">{{ $order->customer->phone ?? '' }}</div>
                                        </div>

                                        <div class="media-body">
                                            <div class="media-heading text-success">Customer Email </div>
                                            <div class="font-13">{{ $order->customer->email ?? '' }}</div>
                                        </div>
                                        <div class="media-body">
                                            <div class="media-heading text-success">Customer Address </div>
                                            <div class="font-13">{{ $order->customer->city ?? '' }},{{ $order->customer->address ?? '' }},{{ $order->customer->pin_code ?? '' }}</div>
                                        </div>
